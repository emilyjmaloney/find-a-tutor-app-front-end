		...
		<div className="grid-col1">
			<div className="weekday monday">
				...
				<div className="grid-col3">
					<div className="slot-yes">{"Morning Session"}</div>
					<div className="slot-no">{"Afternoon Session"}</div>
					<div className="slot-yes">{"Evening Session"}</div>
				</div>
			</div>
			<div className="weekday tuesday">
				...
				<div className="grid-col3">
					<div className="slot-no">{"Morning Session"}</div>
					<div className="slot-yes">{"Afternoon Session"}</div>
					<div className="slot-no">{"Evening Session"}</div>
				</div>
			</div>
